...
cmd = sh (script: "if  grep -q 'ApexClass' 'package/package.xml' ; then echo 'the string exists' ; else echo 'the string does not exist' ; fi",returnStdout:true)

cmd2 = sh (script: "if  grep -q 'ApexTrigger' 'package/package.xml' ; then echo 'the string exists' ; else echo 'the string does not exist' ; fi",returnStdout:true)
